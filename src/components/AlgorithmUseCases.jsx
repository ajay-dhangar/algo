...
const algorithmData = {
  "Binary Search": {
    uses: ["Search engines", "Database indexing", "Dictionary search"],
    description:
  ...
  "Merge Sort": {
    uses: ["Big data processing", "External sorting", "Stable sorting systems"],
    description:
  ...
  "Bubble Sort": {
    uses: ["Educational purposes", "Small datasets", "Beginner learning"],
    description:
  ...
  "Quick Sort": {
    uses: ["Fast in-memory sorting", "Programming libraries", "Competitive programming"],
    description:
  ...
  "DFS": {
    uses: ["Maze solving", "Path finding", "Graph traversal"],
    description:
  ...
  "BFS": {
    uses: ["Shortest path in graphs", "Social network connections", "Web crawling"],
    description:
  ...
  "Dijkstra Algorithm": {
    uses: ["Google Maps", "GPS navigation", "Network routing"],
    description:
  ...
  "Stack": {
    uses: ["Undo feature", "Expression evaluation", "Browser history"],
    description:
  ...
  "Queue": {
    uses: ["CPU scheduling", "Printer queue", "Task processing"],
    description:
  ...
  "Linked List": {
    uses: ["Music playlists", "Memory management", "Dynamic data storage"],
    description:
  ...
  "Recursion": {
    uses: ["Tree traversal", "Backtracking problems", "Divide and conquer algorithms"],
    description:
  ...
  "Dynamic Programming": {
    uses: ["Optimization problems", "Game development", "Resource management"],
    description:
  ...
  return (
    ...
    >
        ...
        {Object.keys(algorithmData).map((algo) => {
          ...
          return (
            <button
              ...
              onMouseEnter={(e) => {
                if (!isSelected) e.currentTarget.style.background = "#cbd5e1";
              }}
              onMouseLeave={(e) => {
      ...
      >
        ...
        <h3 style={{ color: "#334155" }}>Real-World Applications</h3>
