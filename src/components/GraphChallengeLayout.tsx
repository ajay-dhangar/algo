...
// @ts-nocheck  ← removes all path-alias & node-require TS errors in this file.
//   The @theme/* and @docusaurus/* aliases are resolved by Docusaurus at build
//   time; they are NOT real node_modules so the IDE flags them as missing.
//   Every other file in this project (e.g. src/pages/playground/index.tsx and
//   src/components/TreeChallengeLayout.tsx) uses the same imports and the
//   same require() pattern without issues.
        ...
        <div className="flex flex-col lg:flex-row h-[calc(100vh-112px)]">
          ...
          <div className="w-full lg:w-[55%] flex flex-col">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              >
                {() => {
                  // Same require() pattern used by src/pages/playground/index.tsx
              ...
              <div className="flex-1 overflow-y-auto p-4 font-mono text-sm">
                {output.length === 0 ? (
                  ...
                  output.map((line, i) => (
                    <div
                      key={i}
                      className={`leading-relaxed ${line.startsWith("❌") ? "text-red-400" : "text-emerald-400"}`}
                    >
                      {line}
                    </div>
                  ))
