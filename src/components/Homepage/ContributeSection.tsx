    ...
    <section className="py-16 bg-gray-100 dark:bg-gray-900">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-12">
          ...
          seasoned developer or a beginner, we welcome all contributions. Here's
          how you can get involved.
        </p>

        <div className="grid gap-10 md:grid-cols-3">
          <a href="https://github.com/ajay-dhangar/algo/fork" target="_blank">
            {/* Fork the Repository */}
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg transition transform hover:scale-105 hover:shadow-xl cursor-pointer">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Start by forking the repository to your GitHub account. This
                will allow you to work on your own copy of the project.
              </p>
            </div>
          </a>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg transition transform hover:scale-105 hover:shadow-xl cursor-pointer">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Once forked, create a new branch for your feature or bug fix. This
              ensures that your changes can be reviewed independently.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg transition transform hover:scale-105 hover:shadow-xl cursor-pointer">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              After making your changes, submit a pull request. Our team will
              review your contribution and get back to you soon.
            </p>
          </div>
        </div>
