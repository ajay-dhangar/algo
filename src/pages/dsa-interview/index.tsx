...
const DSAQuestions: React.FC = () => {
    ...
    return (
        <Layout title="DSA Questions" description="Frequently asked DSA interview questions.">
                            ...
                            <AnimatePresence>
                                {openProblems[key] && (
                                    ...
                                    >
                                        ...
                                        <div className="relative mt-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg border-l-4 border-blue-600">
