...
const DataStructuresQuiz = () => {
  const questions = [
    {
        question: "1. Which of the following statement is true about Red-Black Tree?",
        options: ["P1 & P4", "P2 & P3", "P1 & P3", "P1 & P2"],
        answer: "P1 & P2",
      },
      {
        question: "2. The condition in which Red-Black trees are preferred over AVL trees?",
        options: [
      ...
      {
        question: "3. A self-balancing binary search tree that optimizes for insertions and deletions rather than strict balance is called:",
        options: ["AVL tree", "Red-Black tree", "Splay tree", "B + Tree"],
        answer: "Red-Black tree",
      },
      {
        question: "4. ________is an advanced data structure based on a trie that is optimized for palindromic strings.",
      ...
      {
        question: "7. What makes an XOR Linked list better than an ordinary linked List?",
        options: [
      ...
      {
        question: "8. What is the time complexity taken by Red-Black Tree in insertion, deletion, and searching Operations?",
        options: ["O(N)", "O(1)", "O(h)", "O(LogN)"],
        answer: "O(LogN)",
      },
      {
        question: "9. Which operation is used to fix violations in a Red-Black Tree after a node deletion?",
      ...
      {
        question: "11. What is the time complexity for searching an element in the Trie?",
        options: ["O(1)", "O(LogN)", "O(N)", "O(N^2)"],
        answer: "O(N)",
      },
      {
        question: "12. What should be placed in the below blank space to complete the find function in Disjoint set?",
        options: ["i", "0", "find(i)", "find(parent[i])"],
        answer: "find(parent[i])",
      },
      {
        question: "13. What is the main purpose of the disjoint-set data structure?",
        options: [
        ...
        answer: "To efficiently perform union and find operations on disjoint sets",
      },
      {
        question: "14. A suffix array can be constructed from____ traversal of the suffix tree.",
        options: ["Breadth-first - search", "Depth-first - search", "Level- order", "None"],
        answer: "Depth-first - search",
      },
      {
        question: "15. Which of the following statements are true about Trie Data structure?",
        options: [
      ...
      },
      {
        ...
        answer: "A tree in which each node can have an arbitrary number of children",
      },
      {
        question: "17. Which of the following is rotation in splay tree?",
        options: ["Zig- Zag Rotation", "Zag Rotation", "Zag - Zag Rotation", "All of these"],
        answer: "All of these",
      },
      {
        question: "18. Unlike trie(standard) data structure where each node contains 26 pointers for its children, each node in a ternary search tree contains ________ pointers:",
        options: ["Only 2", "Only 3", "Only 1", "None"],
        answer: "Only 3",
      },
      {
        question: "19. Path Compression algorithm used in the Union-Find (Disjoint-Set) data structure, performs in which of the following operations?",
        options: ["Create operation", "Insert operation", "Find operation", "Delete operation"],
        answer: "Find operation",
      },
      {
        question: "20. Which of the following is the application of the Trie?",
        options: ["Integer arithmetic operations.", "Pattern Searching", "Sorting and merging large datasets.", "Implementation of Heap"],
        answer: "Pattern Searching",
      },
      {
        question: "21. Which of the following is true about persistence data structure?",
        options: [
      ...
      },
      {
        ...
        answer: "An inorder traversal of the nodes yields the values in the same order",
      },
      {
        question: "23. Which of the following is the application of the BK - Tree?",
        options: ["Spell checker", "Approximate string matching", "Both of the above", "None"],
        answer: "Both of the above",
      },
      {
        question: "24. Which of the following is the self-balancing binary search tree?",
        options: ["AVL Tree", "Red Black Tree", "Splay Tree", "All of the Above"],
        answer: "All of the Above",
      },
      {
        question: "25. Which one of the following data structures is preferred in database-system implementation?",
      ...
      {
        question: "27. What makes an XOR Linked list better than an ordinary linked List?",
        options: [
          "XOR linked list uses more memory",
          "XOR linked list uses less time",
          "XOR linked list uses less memory than an ordinary Linked list",
      ...
      {
        question: "28. What is the time complexity taken by Red-Black Tree in insertion, deletion, and searching Operations?",
        options: ["O(N)", "O(1)", "O(h)", "O(LogN)"],
        answer: "O(LogN)",
      },
      {
        question: "29. Which operation is used to fix violations in a Red-Black Tree after a node deletion?",
        options: ["Trimming", "Recoloring", "Balancing", "None"],
        answer: "Recoloring",
      },
      {
  ...
  return (
    <Layout title="Data Structures Quiz" description="Test your knowledge of data structures with this quiz.">
      <div style={{ padding: "20px" }}>
        <h1>Advanced Data Structures Challenge</h1>
        {showResult ? (
          <div>
            <h2>Your Score: {correctAnswers} out of {questions.length}</h2>
            <h2>Time Spent: {formatTime(timeSpent)}</h2> {/* Show time spent here */}
          </div>
        ) : (
          <div>
            <h2>Time Left: {formatTime(timeLeft)}</h2> {/* Show running timer */}
