      ...
      <Layout>
        <main className="min-h-[80vh] flex items-center justify-center px-4 sm:px-6 py-4 relative overflow-hidden bg-slate-50 dark:bg-gray-950">
          ...
          >
            ...
            <motion.div 
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 text-amber-600 dark:text-amber-400 text-xs font-bold uppercase tracking-wider mb-6"
            ...
            <div className="space-y-2 max-w-md mx-auto mb-8">
              ...
              <p className="text-xs sm:text-sm text-slate-400 dark:text-gray-500 leading-relaxed m-0">
            ...
            <div className="bg-slate-950 rounded-xl p-4 text-left font-mono text-[11px] sm:text-xs text-emerald-400 shadow-inner border border-slate-800/80 mb-8 max-w-lg mx-auto overflow-x-auto">
              <div className="flex items-center gap-1.5 border-b border-slate-800 pb-2 mb-2 text-slate-500 font-sans font-bold uppercase tracking-wider">
                <FiTerminal className="w-3.5 h-3.5 text-slate-400" />
                Stack Trace Diagnostic
              </div>
              <p className="m-0 text-slate-500 font-semibold">&gt; executing router lookups...</p>
