...
## Time and Space Complexity
    - ## Time Complexity
O(...) The time complexity is O(n log n) due to the sorting of processes, where n is the number of processes.
    - ## Space Complexity
O(...) The space complexity is O(n) due to the storage of waiting times and turnaround times.
