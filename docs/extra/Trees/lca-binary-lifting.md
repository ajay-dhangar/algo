...
<Tabs>
  <TabItem value="cpp" label="C++" default>
    ...
    int main() {
        ...
        cout << "LCA of 3 and 6: " << lcaFinder.getLCA(3, 6) << " (Expected: 1)" << endl;
        cout << "LCA of 6 and 5: " << lcaFinder.getLCA(6, 5) << " (Expected: 0)" << endl;
        cout << "LCA of 4 and 6: " << lcaFinder.getLCA(4, 6) << " (Expected: 4)" << endl;
