...
import { TrieVisualizer } from '@site/src/components/Visualizing/TrieVisualizer';
...
Try inserting, searching, and deleting words in the interactive Trie below to see how the data structure works in real-time:
