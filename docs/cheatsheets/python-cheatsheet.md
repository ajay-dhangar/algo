...
```py title="Swap and unpack values in Python"
...
```py title="Ternary expression in Python"
...
```py title="zip and enumerate in Python"
...
```py title="map and filter in Python"
...
```py title="sorted and reversed in Python"
...
```py title="any, all, sum and round in Python"
...
```py title="Comprehensions in Python"
...
```py title="collections imports in Python"
from collections import defaultdict, Counter, deque, namedtuple
```

### `defaultdict`

```py title="defaultdict in Python"
...
```py title="String methods in Python"
...
```py title="lru_cache memoization in Python"
...
```py title="itertools import in Python"
import itertools as it
```

### `combinations`, `permutations`, `product`

```py title="Combinations permutations and product in Python"
...
```py title="try except finally in Python"
try:
...
```py title="Context manager with statement in Python"
...
```py title="Class inheritance in Python"
class Base:
    def ping(self):
...
```py title="Abstract base class in Python"
...
```py title="Generator function in Python"
def gen(n):
    for i in range(n):
...
```py title="Async coroutine in Python"
import asyncio
...
```py title="Walrus operator in Python"
