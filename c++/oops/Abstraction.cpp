// example of abstraction in C++ using an abstract class to demonstrate how it hides implementation details and ensures that derived classes must implement the essential functionality.
