---
id: arrays-shellsort
title: Arrays - Shell Sort in DSA (हिंदी)
sidebar_label: शेल सॉर्ट
...
# Output: [11, 12, 22, 25, 34, 64, 90] (हिंदी)
```
...
# # Shell Sort vs Insertion Sort (हिंदी)
